  ...
  return (
    <div className='flex items-center justify-between py-6 '>  
      ...
      <div className='flex items-center justify-between gap-4'>         
        ...
        <div className='hidden sm:flex sm:bg-black w-[40px] h-[40px] rounded-[21px] justify-center items-center px-10'>     
            <span className='text-white '>Cart</span> 
        </div> 
        <div className=' w-[41px] h-[41px]  border-black sm:w-[40px] sm:h-[40px] border-6 rounded-full '>
      ...
      <div className={`fixed top-0 left-0 w-full h-full bg-white transition-all z-50 opacity-100  ${visible ? 'block' : 'hidden'}`}>           
