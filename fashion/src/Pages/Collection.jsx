...
const applyFilter = () => {    
  ...
  useEffect(() => {
    applyFilter();
  }, [size, products, Category, subCategory]);
      ...
      <div className="flex flex-col md:flex-row gap-1 sm:gap-10 pt-5  h-auto">
        <div className="flex flex-col items-center md:items-start w-[330px] sm:w-[357px] md:hidden justify-center   mx-auto  ">
          <div className="flex  w-1/2 items-center justify-center md:justify-start">
            ...
            <span className="text-gray-800 text-[12px] pl-[1px]">
              / Products
            </span>
          </div>
        ...
        {/* left side */}
        <div
          className={`overflow-hidden md:flex mx-w-[266px] ${  
            showFilter ? "flex relative" : ""
          }`}
        >
          <div
          ...
          >
            <p
              ...
              className={`my-2 text-[14px] font-semibold tracking-wider font1 flex items-center cursor-pointer gap-2 ${
                showFilter ? "justify-between" : ""
              }`}
            >
              Filters{" "}
              <img
                className={`h-3 md:hidden ${showFilter ? "rotate-180 " : ""}`}
            ...
            <div className={`md:flex ${showFilter ? "flex" : "hidden"}`}>
              <div
                className={`flex flex-col ${
                  showFilter ? "w-[160px] h-auto max-h-[565px]" : "hidden"
                } md:block`}
              >
                <p className="font1 font-medium tracking-wider text-[14px]">
                  Sizes
                </p>
                <div className="flex gap-1 pt-2">
                  {["S", "M", "L", "XL"].map((sz) => (
                    <button
                      ...
                      className={`w-[25px] h-[25px] md:w-[38px] md:h-[39px] border border-gray-400 font1 text-[12px] font-semibold flex items-center justify-center 
                      ${size.includes(sz) ? "bg-black text-white" : ""}`}  
                    >
                      {sz}
                    </button>
                  ))}
                  ...
                  {openSection === "availability" && (
                    <div className="py-2 flex flex-col gap-2">
                      <label className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-[12px] tracking-wide font1 font-normal">
                          Availability
                        </span>
                      </label>
                      <label className="flex items-center gap-2 text-sm">
                        <input
                          type="checkbox"
                          className="w-[20px] h-[21px] border-gray-300 border-1 "
                        />
                        <span className="text-[12px] tracking-wide font1 font-normal">         
                          Out of stock
                        </span>
                ...
                <div className="border-t-2 border-dotted border-gray-300 mt-1 ">
                  ...
                  >
                    ...
                    <img
                      className={`transform transition-transform duration-200 w-[8px] rotate-90 h-[10px] filter brightness-10 ${
                        openSection === "category" ? "rotate-270" : ""
                      }`}
                      src={assets.dropdown_icon}
                      alt=""
                    />
                  ...
                  {openSection === "category" && (
                    <div className="py-2 flex flex-col gap-2">
                      <label className="flex items-center gap-2 text-sm">
                        <input type="checkbox" value={'Men'} className="w-[20px] h-[21px]" onChange={toggleCategory} />
                        <span className="text-[12px] tracking-wide font1 font-normal">
                          Men
                        </span>
                      </label>
                      <label className="flex items-center gap-2 text-sm">
                        <input
                          type="checkbox" value={'Women'} onChange={toggleCategory}
                          className="w-[20px] h-[21px] border-gray-300 border-1 "
                        />
                        <span className="text-[12px] tracking-wide font1 font-normal">
                          Women
                ...
                <div className="border-t-2 border-dotted border-gray-300 mt-1 ">
                  ...
                  >
                    ...
                    <img
                      className={`transform transition-transform duration-200 w-[8px] rotate-90 h-[10px] filter brightness-10 ${
                        openSection === "collections" ? "rotate-270" : ""
                      }`}
                      src={assets.dropdown_icon}
                      alt=""
                    />
                  ...
                  {openSection === "collections" && (
                    <div className="py-2 flex flex-col gap-2">
                      <label className="flex items-center gap-2 text-sm">
                        <input type="checkbox" className="w-[20px] h-[21px]" value={'Topwear'}onChange={(e) => toggleSubCategory(e.target.value)}/>
                        <span className="text-[12px] tracking-wide font1 font-normal">
                          top Wear
                        </span>
                      </label>
